...
new_scan = """function scanGmailReplies() {
  try {
...
content = content[:start_idx] + new_scan + content[end_idx + len("/**\n * 處理附件與 HTML 內之 Google Drive 連結替換\n */\n"):]

with open('google_apps_script_webapp_updated_v2.gs', 'w', encoding='utf-8') as f:
    f.write(content)
    
with open(r'C:\Users\hia\.gemini\antigravity\brain\0bcd63bf-efa0-447f-95ba-2e5132fbd4e5\GAS_Code_V2.md', 'w', encoding='utf-8') as fw:
    fw.write('```javascript\n' + content + '\n```\n')
