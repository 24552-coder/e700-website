...
with open('google_apps_script_webapp_updated_v3.gs', 'w', encoding='utf-8') as f:
    f.write(content)
    
with open(r'C:\Users\hia\.gemini\antigravity\brain\0bcd63bf-efa0-447f-95ba-2e5132fbd4e5\GAS_Code_V3.md', 'w', encoding='utf-8') as fw:
    fw.write('```javascript\n' + content + '\n```\n')
